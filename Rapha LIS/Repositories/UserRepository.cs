    ...
    public class UserRepository : BaseRepository, IUserControlRepository
    {
        ...
        public void AddUser(UserModel userModel)
        {
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                using (var command = new SqlCommand())
                {
                    ...
                    command.CommandText = "INSERT INTO Users (FirstName, LastName, MiddleInitial, Age, Sex, Birthdate, " +
        ...
        public IEnumerable<UserModel> GetAll()
        {
            ...
            using (var command = new SqlCommand())
            {
                connection.Open();
                command.Connection = connection;
                command.CommandText = "SELECT * FROM Users ORDER BY DateCreated DESC";
